  ...
  return (
    <Root>
      {resumes?.length
        ? resumes.map((resume) => {
            const city =
              resume.cities_ua && resume.cities_ua.length
                ? `, ${resume.cities_ua[0].name}`
                : '';
                ...
                <CardItem>
                  <Left style={{ flex: 1.5 }}>
                    ...
                    <Text style={styles.infoText}>
                      Просмотров:{' '}
                      <Text style={styles.infoTextBold}>{resume.views}</Text>
                    </Text>
                  </Left>
                  <Left style={{ flex: 1.3 }}>
                    <Icon
                  ...
                  <Left>
                    ...
                    />
                    <Text style={styles.infoTextBold}>
                      {formatDateFromSql(resume.updated_at)}
                    </Text>
                  </Left>
                </CardItem>
                <CardItem
